...
5. To get GT 520M working under 10.14 Beta 2 or above versions, use [/Extras/CoreDisplay](https://github.com/badruzeus/Hackintosh-Asus-A43SJ/blob/master/Extras/CoreDisplay.zip) binary and place to:
...
`/System/Library/Displays/Contents/Resources/Overrides`
 - Follow my [Youtube Video Tutorial](https://www.youtube.com/watch?v=cX-tBC71hHM) to fix Display Color Banding issue with Nvidia graphics. 
